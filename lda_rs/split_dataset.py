...
class SplitSet:
  ...
  def __init__(self):
    self.whole_data = read_file(path='../dataset/small/ratings.csv')
...
def main():
  ...
  write_file(trainset,'../dataset/outputFile/rating_train.csv')
  print 'trainset writing end\n'
  print 'begin to write testset\n'
  write_file(testset,'../dataset/outputFile/rating_test.csv')
